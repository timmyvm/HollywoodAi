...
export default function Testimonials() {
  return (
    ...
    <div className="py-16 mx-auto">
      <div className=" max-w-[1280px] mx-auto px-5 bg-gray-100 flex flex-col  items-center p-20 rounded-3xl border border-gray-300 bg-cover bg-center" style={{ backgroundImage: "url('/assets/world-map.png')" }}>
        ...
        <div className="flex gap-10 flex-col md:flex-row">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 text-base font-medium text-center max-w-xs">
