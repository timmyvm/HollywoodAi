      ...
      <div className="m-4 md:m-0 py-16">
        <div className="max-w-[1280px] mx-auto px-2 md:px-5 bg-[url('/assets/steps-bg.jpg')] 
          ...
          <div className="flex relative flex-col md:flex-row">
            ...
            <div className="flex mb-5 flex-col items-center px-[20px] group transition-all duration-500 hover:scale-110 hover:translate-y-[-12px]">
              <div className="w-16 h-16 border-[1px] border-[hsla(0, 0%, 100%, 0.17)] 
              ...
              <div className="text-[18px] font-light leading-6 max-w-[280px] w-full flex items-center flex-col justify-center text-center"> 
            ...
            <div className="flex mb-5 flex-col items-center px-[20px] group transition-all duration-500 hover:scale-110 hover:translate-y-[-12px]">
              ...
              <div className="text-[18px] font-light leading-6 max-w-[280px] w-full text-center">
