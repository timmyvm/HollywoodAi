    ...
    <header className="flex-col justify-center bg-gradient-to-r from-[#70acd4] via-[#ca71ff] to-[#70acd4] bg-[length:200%_200%] py-[52px] h-[90vh] flex items-center relative animate-gradient">
      <div className="flex flex-col justify-center items-center">
        ...
        <LogInModal
          ...
          icon={<FontAwesomeIcon icon={faPlay} className="h-[14px] w-[14px]" />}

          style=" text-white py-[12px] px-[16px] font-semibold bg-[rgba(0,0,0,0.1)] flex justify-center items-center text-[17px] 
          leading-[20px] gap-[16px] rounded-[48px] h-[64px] cursor-pointer transition duration-300 hover:bg-[rgba(0,0,0,0.2)]"

          style2="w-[40px] h-[40px] p-[12px] rounded-full bg-white text-[rgb(55,57,61)] flex justify-center items-center"
        />
      </div>
      <svg
