    ...
    <section id="summary" className="mt-[40px]">
      <div className="py-16">
        <div className="max-w-[1280px] mx-auto px-5 flex flex-wrap justify-between rounded-[50px] border border-gray-300 p-[80px]">
          <div className="summary__text w-full md:w-[47%]">
            <div className="summary__widget flex items-center gap-[6px] bg-[#dde6ff] px-[13px] py-[5px] rounded-[20px] mb-[110px] w-fit text-[12px] font-bold leading-[11px]">
            ...
            <p className="summary__para text-[15px] md:text-[17px] leading-[1.47em] text-[#7e7f8e]">
          ...
          <figure className="summary__figure w-full md:w-[47%] flex flex-col items-center bg-[#dde6ff] rounded-[12px] p-[30px]">
